...
namespace ANEO.Base.P2P.PR.Map
{
    ...
    public class MapPRMaster : MapGeneral
    {
        ...
        [JsonProperty("nonftn")]
        public virtual bool NonFTN { get; set; }
        [JsonProperty("mode")]
    ...
    public class MapPRMasterDetail
    {
        ...
        [Grid(Width = 150, IsSortable = false, Alignment = ColumnsAlignment.Right, DecimalPlaces = 2)]
        public virtual string  UnitCost { get; set; }
        [JsonProperty("amount")]
        [Grid(Width = 150, IsSortable = false, DecimalPlaces = 2 )]
        ...
        [JsonProperty("est")]
        [Grid(Width = 150, IsSortable = false, DatetimeFormat = "DD/MM/YYYY")]
    ...
    public class MapConvertPRtoPO
    {
        ...
        public virtual DateTime PRM_PR_DATE { get; set; }
